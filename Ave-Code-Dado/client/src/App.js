...
<div class="row green">
      <div class="col s12 card-panel teal green z-depth-0"><h2 class="center-align">Kalorien</h2></div>
    ...
    <div class="row brown lighten-2"> 
                <div class="col s12 card-panel brown lighten-2 z-depth-0"><h4 class="center-align"> Heute </h4></div>
                <div class="col s1 card-panel brown lighten-2 lighten-4 z-depth-0"></div>
                <div class="col s4 white"> <h5 class="center-align">Frühstück</h5><h6 class="center-align">123 Kalorien</h6> </div>
                <div class="col s2 card-panel brown lighten-2 lighten-4 z-depth-0"></div>
                <div class="col s4 white"> <h5 class="center-align">Mittagessen</h5><h6 class="center-align">123 Kalorien</h6></div>
                <div class="col s12 card-panel brown lighten-2 z-depth-0"></div>
                <div class="col s12 card-panel brown lighten-2 z-depth-0"></div>
                <div class="col s1 card-panel brown lighten-2 lighten-4 z-depth-0"></div>
                <div class="col s4 white"> <h5 class="center-align">Abendessen</h5> <h6 class="center-align">123 Kalorien</h6></div>
                <div class="col s2 card-panel brown lighten-2 lighten-4 z-depth-0"></div>
                <div class="col s4 white"> <h5 class="center-align">Snacks</h5> <h6 class="center-align">123 Kalorien</h6></div>
            </div>
        ...
        <ul>
            ...
            <li>
                <a href="/addAbendessen" class="btn-floating blue">
                   <i class="material-icons"> restaurant</i>{/* Abendessen*/}
                </a>
            </li>
            <li>
                <a href="/addSnack" class="btn-floating blue">
                   <i class="material-icons"> icecream</i>{/* Snacks*/}
                </a>
            </li>
            <li>
